...
class DimCompany(models.Model):
    # Profile mapping based on your JSON output
    ...
    company_name = models.TextField(db_column='year', blank=True, null=True)
...
class FactProfitLoss(models.Model):
    # Mapping perfectly to the column order in your Excel screenshot!
    symbol = models.TextField(db_column='year_label', primary_key=True) # Column B
    year = models.TextField(db_column='year', blank=True, null=True) # Column C
    revenue = models.FloatField(db_column='unnamed:_3', blank=True, null=True) # Column D
    net_profit = models.FloatField(db_column='unnamed:_12', blank=True, null=True) # Column M
    eps = models.FloatField(db_column='unnamed:_13', blank=True, null=True) # Column N
